	...
	private function register_query_section_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#ffffff',
				'selectors' => [
					'{{WRAPPER}} .bdt-twitter-carousel .bdt-twitter-carousel-item' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-twitter-carousel .bdt-twitter-carousel-item .bdt-twitter-text,
					{{WRAPPER}} .bdt-twitter-carousel .bdt-twitter-carousel-item .bdt-twitter-text *' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-twitter-carousel .bdt-twitter-carousel-item .bdt-card-body' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name'     => 'item_shadow',
				'selector' => '{{WRAPPER}} .bdt-twitter-carousel .bdt-twitter-carousel-item',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-twitter-carousel .bdt-twitter-carousel-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-twitter-carousel .bdt-twitter-carousel-item:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-twitter-carousel .bdt-twitter-carousel-item:hover' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bdt-twitter-carousel .bdt-twitter-carousel-item:hover',
			]
		);

...
function ep_shortcode_clipboard($atts = null, $content = null) {
    ...
    $output = '<span class="ep-sc-clipboard' . Element_Pack_Shortcodes::ep_get_css_class($atts) . '" bdt-tooltip="Click to Copy">';
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function(event) { 
            var clipboard = new ClipboardJS('.ep-sc-clipboard', {
                target: function(e) {
                    return e;
                }
            });

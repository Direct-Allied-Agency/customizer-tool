 ...
 */
function orbisius_ct_top_line_dtg_child_theme_enqueue_styles() {
    $parent_style = 'orbisius_ct_top_line_dtg_parent_style';
    $parent_base_dir = 'oceanwp';
...
add_action( 'wp_enqueue_scripts', 'orbisius_ct_top_line_dtg_child_theme_enqueue_styles' );
